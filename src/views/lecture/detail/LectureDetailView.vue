        ...
        <v-row>
            ...
            <v-col cols="4">
                <aside class="float-info">
                    ...
                    <v-btn v-if="isLogin === true" @click="openApplyModal"
                        ...
                        <div v-if="lectureInfo?.lectureType === 'LESSON'">
                            ...
                            <v-row>
                                <v-col>
                                    ...
                                    <v-btn style="border: 1px solid #ccc; padding-left:5px;" variant="outlined"
                                        class="ml-3 mb-2" @click="updateAddress()"><v-icon>mdi-map-search</v-icon> 주소
                                        검색</v-btn>
            ...
            try {
                ...
                if (data.result && Array.isArray(data.result) && data.result.length > 0) {
                    ...
                    this.lectureGroups = data.result.map((group, index) => ({
                        ...
                        price: group.price || 0,
                        participants: group.groupTimes.remaining || 1,
